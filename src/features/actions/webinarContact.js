...
export const getAllWebinarsForPage = createAsyncThunk(
  "webinars/fetchData/page",
  async ({ page = 1, limit = 10, filters = {} }, { rejectWithValue }) => {
    try {
      const response = await instance.post(`/webinar/data`,{ filters }, {
        params: { page, limit },
...
export const getAllWebinarsSilently = createAsyncThunk(
  "webinars/fetchDataSilently",
  async ({ page = 1, limit = 10, filters = {} }, { rejectWithValue }) => {
    try {
      const response = await instance.post(`/webinar/data`,{ filters }, {
        params: { page, limit },
