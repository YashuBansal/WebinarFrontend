...
export const getAdminDashboardData = createAsyncThunk(
  ...
  async (params, { rejectWithValue }) => {
    try {
      const response = await instance.get(`dashboard/admin`, { params });
      return response?.data;
    } catch (e) {
      return rejectWithValue(e);
    }
...
export const getAdminNotesForDashboard = createAsyncThunk(
  "admin/notes/fetchData",
  async (params, { rejectWithValue }) => {
    try {
      const response = await instance.get(`notes/dashboard/admin`, { params });
      return response?.data;
    } catch (e) {
      return rejectWithValue(e);
    }
...
export const getEmployeeDashboardData = createAsyncThunk(
  "employee/Dashboard/fetchData",
  async (params, { rejectWithValue }) => {
    try {
