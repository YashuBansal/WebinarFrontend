...
import { capitalizeWords, errorToast, successToast } from "../../utils/extra";
...
export const assignSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAssignmentsSilently.pending, (state, action) => {})
      .addCase(getAssignmentsSilently.fulfilled, (state, action) => {
        const { result = [], pagination = {} } = action.payload;
        state.assignData = result;
        state.pagination = pagination;
      })
      .addCase(getAssignmentsSilently.rejected, (state, action) => {
        errorToast(action?.payload);
      })
      ...
      .addCase(cancelRequestReAssignment.pending, (state, action) => {
        state.assignLoading = true;
        state.isSuccess = false;
      })
      .addCase(cancelRequestReAssignment.fulfilled, (state, action) => {
        state.assignLoading = false;
        state.isSuccess = true;
        successToast("Request Cancelled Successfully");
      })
      .addCase(cancelRequestReAssignment.rejected, (state, action) => {
        state.assignLoading = false;
        errorToast(action?.payload);
      })
