...
import {
  ...
  exportClientBillings,
  exportProductRevenue,
...
const exportSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(exportEmployeeAssignmentsExcel.pending, (state, action) => {
        state.isLoading = true;
        state.isSuccess = false;
        state.isExportLoading = true;
      })
      .addCase(exportEmployeeAssignmentsExcel.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        state.isSuccess = true;
        successToast(`Data Exported Successfully`);
      })
      .addCase(exportEmployeeAssignmentsExcel.rejected, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        errorToast(action.payload);
      })
      .addCase(exportProductRevenue.pending, (state, action) => {
        state.isLoading = true;
        state.isSuccess = false;
        state.isExportLoading = true;
      })
      .addCase(exportProductRevenue.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        state.isSuccess = true;
        successToast(`Data Exported Successfully`);
      })
      .addCase(exportProductRevenue.rejected, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        errorToast(action.payload);
      })
      .addCase(exportClientBillings.pending, (state, action) => {
        state.isLoading = true;
        state.isSuccess = false;
        state.isExportLoading = true;
      })
      .addCase(exportClientBillings.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        state.isSuccess = true;
        successToast(`Data Exported Successfully`);
      })
      .addCase(exportClientBillings.rejected, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        errorToast(action.payload);
      })
      .addCase(exportWebinarEnrollments.pending, (state, action) => {
        state.isLoading = true;
        state.isSuccess = false;
        state.isExportLoading = true;
      })
      .addCase(exportWebinarEnrollments.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        state.isSuccess = true;
        successToast(`Data Exported Successfully`);
      })
      .addCase(exportWebinarEnrollments.rejected, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        errorToast(action.payload);
      })
      ...
      .addCase(exportUserActivitiesByUser.pending, (state, action) => {
        state.isLoading = true;
        state.isSuccess = false;
        state.isExportLoading = true;
      })
      .addCase(exportUserActivitiesByUser.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isSuccess = true;
        state.isExportLoading = false;
        successToast(`Data Exported Successfully`);
      })
      .addCase(exportUserActivitiesByUser.rejected, (state, action) => {
        state.isLoading = false;
        state.isExportLoading = false;
        errorToast(action.payload);
      })
