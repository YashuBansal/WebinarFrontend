  ...
  return (
    <div className="min-h-screen bg-gray-50 py-10 px-4">
      <div className="max-w-4xl mx-auto bg-white border rounded-lg p-6 md:p-8">
        <h1 className="text-2xl md:text-3xl font-semibold mb-2">Documentation</h1>
        ...
        <div className="space-y-5 text-sm text-gray-700 leading-6">
          <section>
            ...
            <p>
              Start by creating your account, configuring your workspace, and inviting
              team members with appropriate roles.
            </p>
          </section>

          <section>
            <h2 className="font-semibold text-base mb-1">2. Integration Setup</h2>
            <p>
              Follow integration-specific setup steps, verify webhook endpoints, and
          ...
          <section>
            ...
            <p>
              Check configuration values, token status, and logs. For unresolved issues,
