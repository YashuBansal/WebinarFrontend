      ...
      <div className="max-w-4xl mx-auto bg-white border rounded-lg p-6 md:p-8">
        ...
        <div className="space-y-5 text-sm text-gray-700 leading-6">
          <section>
            ...
            <p>
              By using this service, you agree to these terms and all applicable
              laws.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You are responsible for account access, credentials, and all
          ...
          <section>
            ...
            <p>
              We may update, suspend, or improve features to maintain security
              and product quality.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by law, the service is provided on
              an as-is basis without indirect or consequential liability.
            </p>
          </section>
        </div>
