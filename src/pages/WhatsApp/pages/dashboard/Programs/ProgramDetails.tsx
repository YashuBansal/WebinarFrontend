    ...
    return (
      <div className="min-h-full flex items-center justify-center p-8 bg-white dark:bg-slate-950 shadow-sm">
        <Alert variant="destructive" className="max-w-md rounded-[32px] p-8 border border-red-100 dark:border-red-900/50 shadow-2xl bg-white dark:bg-slate-900">
          ...
          <AlertTitle className="text-xl font-black text-slate-900 dark:text-white mb-2">Missing Context</AlertTitle>
    ...
    return (
      <div className="min-h-[400px] flex items-center justify-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-slate-600 dark:text-slate-400 font-bold text-xs uppercase tracking-widest animate-pulse">Loading sequence details...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex flex-wrap items-center gap-4 mt-2">
                  ...
                  <div className="flex items-center gap-2">
                    {program.isDeleted ? (
                      ...
                      <Badge variant="secondary" className="bg-slate-100 dark:bg-slate-950 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-800 rounded-full px-3 py-0.5 text-[9px] font-black uppercase tracking-widest">
                        Inactive
                      </Badge>
                    )}
                  </div>
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="h-11 px-6 rounded-xl flex items-center gap-2 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-800 font-bold text-sm transition-all active:scale-[0.98] shadow-sm"
            >
        ...
        <div className="space-y-8">
          ...
          >
            <div className="flex items-center gap-3 mb-6 px-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-600 dark:text-slate-400">Sequence Timeline</span>
            </div>
