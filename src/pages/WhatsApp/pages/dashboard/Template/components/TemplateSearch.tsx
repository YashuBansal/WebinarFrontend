  ...
  return (
    <div className="relative group">
      ...
      <Input
        ...
        className="h-11 pl-11 pr-4 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white dark:bg-slate-800/50 focus:ring-green-500/20 focus:border-green-500 transition-all text-sm font-medium"
      />
    </div>
  );
}
