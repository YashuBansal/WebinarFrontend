    ...
    <div className="min-h-full w-full min-w-0 max-w-full box-border p-2 transition-colors duration-500 sm:p-2 md:p-0 lg:p-0 xl:p-2 2xl:p-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-xs font-medium">
                Automate WhatsApp responses for <span className="text-slate-900 dark:text-white font-bold">New Registrations</span>
              </p>
            </div>
          </div>
      ...
      <main className="container mx-auto space-y-6 pb-12">
        ...
        >
          ...
          <div className="relative z-10">
            <div className="mb-8 px-6 pt-6">
              <h2 className="text-xl font-black text-slate-900 dark:text-white">Message Content</h2>
              <p className="text-slate-500 dark:text-slate-400 text-xs font-medium mt-1">Select a template and map its variables to registration data</p>
            </div>
        ...
        <motion.div
          ...
          className="group relative bg-white dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 hover:border-green-400/50 dark:hover:border-green-500/50 hover:shadow-xl hover:shadow-green-900/5 dark:hover:shadow-green-500/10 rounded-2xl p-6 sm:p-8 transition-all duration-300"
        >
          ...
          <div className="relative z-10">
            <div className="mb-8">
              <h2 className="text-xl font-black text-slate-900 dark:text-white">Trigger Conditions</h2>
              <p className="text-slate-500 dark:text-slate-400 text-xs font-medium mt-1">Define which webinar registration should trigger this message</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-end">
                ...
                >
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className={`w-full justify-between h-12 rounded-xl border-slate-200 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 hover:bg-white dark:hover:bg-slate-900/50 transition-all text-left font-medium ${showValidationErrors && isWebinarIdMissing ? "border-red-500 ring-1 ring-red-500" : ""
                        }`}
                      disabled={webinarsLoading}
                    >
                      {selectedWebinar ? (
                        <div className="flex items-center gap-3 flex-1 min-w-0">
                          <div className="h-8 w-8 rounded-lg bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50 flex items-center justify-center text-green-600 dark:text-green-400">
                  ...
                  <PopoverContent className="w-[400px] p-0 rounded-2xl overflow-hidden border-slate-200 dark:border-slate-700/50 shadow-2xl" align="start">
                          ...
                          {webinars && webinars.length > 0 ? (
                            webinars.slice().reverse().map((webinar: any) => (
                              <CommandItem
                                ...
                                className="cursor-pointer py-3 px-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-900/50 aria-selected:bg-slate-50 transition-colors"
                              >
                                <div className="flex items-center justify-between w-full">
                                  ...
                                  <Check
                                    className={`ml-2 h-4 w-4 text-green-600 dark:text-green-400 transition-opacity ${webinarId === webinar._id ? "opacity-100" : "opacity-0"
                                      }`}
                                  />
                                </div>
                              </CommandItem>
              ...
              <div className="p-4 rounded-2xl bg-blue-50 dark:bg-blue-500/10 border border-blue-100 dark:border-blue-500/20 flex gap-4 items-start">
            ...
            {webinarsError && (
              <Alert variant="destructive" className="mt-6 rounded-2xl border-none bg-red-50 dark:bg-red-500/10">
