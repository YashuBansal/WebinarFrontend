...
import { clearNoticeBoardUpdated, resetSuccessAndUpdate } from "../../features/slices/noticeBoard";
...
const UpdateNoticeboard = () => {
  ...
  const { noticeData, isSuccess, isLoading } = useSelector((state) => state.noticeBoard);
        ...
        <div className="mt-6 text-right">
          <Button
            ...
            onClick={() =>
             {
              dispatch(
                updateNoticeBoard({ content: editorContent, type })
              );
              logUserActivity({
                action: 'update',
