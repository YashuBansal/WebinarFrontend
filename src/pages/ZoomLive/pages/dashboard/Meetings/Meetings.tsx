    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
        <div className="space-y-1">
          ...
          <p className="text-muted-foreground">
            Browse and filter your Zoom meetings across types and dates.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Results matching current filters</CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <Alert>
              ...
              <AlertDescription className="whitespace-pre-wrap">
                {getQueryErrorMessage(error, "Failed to load meetings.")}
              </AlertDescription>
            </Alert>
                ...
                .map((meeting, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 ml-4">
                      ...
                      <Button
                        className="cursor-pointer bg-neutral-200 hover:bg-neutral-300"
                        variant="ghost"
                        size="sm"
                        onClick={() =>
                          navigate(
                            `/zoom/dashboard/${projectId}/meetings/${encodeURIComponent(
                              meeting.id
                            )}?start-time=${encodeURIComponent(
                              meeting.startTime || ""
                            )}`
                          )
                        }
