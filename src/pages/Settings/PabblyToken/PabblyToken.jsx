      ...
      <div className="max-w-4xl w-full space-y-8">
        ...
        <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
          <InfoBoxHeader
            ...
            copyText={endpoint}
          />
          <p className="text-gray-700 text-sm break-words">{endpoint}</p>
        </div>

        <ComponentGuard allowedRoles={[roles.SUPER_ADMIN]}>
          <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
            <InfoBoxHeader
              title="Clients API Endpoint ( Method: GET )"
              onCopy={handleCopy}
          ...
          <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
            <InfoBoxHeader
              title="Update Client Subscription Plan ( Method: PATCH )"
              onCopy={handleCopy}
              copyText={`${apiUrl}/subscription/update`}
            />
            <p className="text-gray-700 text-sm break-words">{`${apiUrl}/subscription/update`}</p>
          </div>
        </ComponentGuard>
        ...
        <ComponentGuard allowedRoles={[roles.ADMIN]}>
          <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
            <InfoBoxHeader
              title="Webinar Sales Attendees API Endpoint (Method: GET)"
              onCopy={handleCopy}
          ...
          <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
            <InfoBoxHeader
              title="Webinar Reminder Attendees API Endpoint (Method: GET)"
              onCopy={handleCopy}
        ...
        <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              <button
                onClick={() => handleDownload(jsonBody)}
          ...
          <div className="bg-white shadow-md rounded-lg p-4 sm:p-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
              <h2 className="text-lg font-semibold text-gray-800">
                JSON Body: (Update Client Subscription)
              </h2>
              <div className="flex gap-2 w-full sm:w-auto">
                <button
